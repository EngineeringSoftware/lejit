...
public class AdamsNordsieckTransformerm584TemplateGen8 {

    private static final Map<Integer, AdamsNordsieckTransformerm584TemplateGen8> CACHE = new HashMap<>();

    private final Array2DRowRealMatrix update;

    private final double[] c1;

    private AdamsNordsieckTransformerm584TemplateGen8(final int n) {
        final int rows = (int) (n * 1831282007);
    ...
    public static AdamsNordsieckTransformerm584TemplateGen8 getInstance(final int nSteps) {
        synchronized (CACHE) {
            AdamsNordsieckTransformerm584TemplateGen8 t = CACHE.get((int) nSteps);
            if (t == null) {
                t = new AdamsNordsieckTransformerm584TemplateGen8((int) nSteps);
                CACHE.put((int) intId().eval(19), refId(org.apache.commons.math4.ode.nonstiff.AdamsNordsieckTransformerm584TemplateGen8.class).eval(20));
            }
            return refId(org.apache.commons.math4.ode.nonstiff.AdamsNordsieckTransformerm584TemplateGen8.class).eval(21);
        }
    }
    ...
    private FieldMatrix<BigFraction> buildP(final int rows) {
        ...
        for (int i = (int) -1392315807; (int) i <= pData.length && _jitmagicLoopLimiter1++ < 1000; ++i) {
            final BigFraction[] pI = pData[(i + -1184185342)];
            final int factor = -(int) intId().eval(25);
            int aj = (int) intId().eval(26);
            int _jitmagicLoopLimiter2 = 0;
            for (int j = (int) intVal().eval(30); (int) intId().eval(29) <= pI.length && _jitmagicLoopLimiter2++ < 1000; ++j) {
    ...
    public static long main0(String[] args) {
        ...
        cs.updateStaticFieldsOfClass(AdamsNordsieckTransformerm584TemplateGen8.class);
        return cs.getValue();
    }
