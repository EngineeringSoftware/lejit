...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public StrBuilder(int initialCapacity) {
        if ((boolean) relation(intId(), asInt(0), LE).eval()) {
    ...
    public StrBuilder append(final boolean value) {
        if ((boolean) boolId().eval()) {
            ensureCapacity((int) arithmetic(intId(), asInt(4), ADD).eval());
            buffer[size++] = (char) asChar('t').eval();
            buffer[size++] = (char) asChar('r').eval();
            buffer[size++] = (char) asChar('u').eval();
            buffer[size++] = (char) asChar('e').eval();
        } else {
            ensureCapacity((int) arithmetic(intId(), asInt(5), ADD).eval());
            buffer[size++] = (char) asChar('f').eval();
            buffer[size++] = (char) asChar('a').eval();
            buffer[size++] = (char) asChar('l').eval();
            buffer[size++] = (char) asChar('s').eval();
            buffer[size++] = (char) asChar('e').eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final char ch) {
        ...
        ensureCapacity((int) arithmetic(intId(), asInt(1), ADD).eval());
    ...
    public StrBuilder append(final char[] chars) {
        ...
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            System.arraycopy(refId(char[].class).eval(), (int) asInt(0).eval(), refId(char[].class).eval(), (int) intId().eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final char[] chars, final int startIndex, final int length) {
        ...
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) intId().eval() > chars.length) {
            throw new StringIndexOutOfBoundsException("Invalid startIndex: " + (int) intId().eval());
        }
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) arithmetic(intId(), intId(), ADD).eval() > chars.length) {
    ...
    public StrBuilder append(final CharBuffer buf, final int startIndex, final int length) {
        ...
        if (refId(java.nio.CharBuffer.class).eval().hasArray()) {
            ...
            if ((boolean) logic(relation(intId(), asInt(0), LT), relation(intId(), intId(), GT), OR).eval()) {
                throw new StringIndexOutOfBoundsException("startIndex must be valid");
            }
            if ((boolean) logic(relation(intId(), asInt(0), LT), relation(arithmetic(intId(), intId(), ADD), intId(), GT), OR).eval()) {
    ...
    public StrBuilder append(final StrBuilder str) {
        ...
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            System.arraycopy(str.buffer, (int) asInt(0).eval(), refId(char[].class).eval(), (int) intId().eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final StrBuilder str, final int startIndex, final int length) {
        ...
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) intId().eval() > refId(org.apache.commons.text.StrBuilder.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("startIndex must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) arithmetic(intId(), intId(), ADD).eval() > refId(org.apache.commons.text.StrBuilder.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("length must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            refId(org.apache.commons.text.StrBuilder.class).eval().getChars((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), refId(char[].class).eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final String str) {
        ...
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            refId(java.lang.String.class).eval().getChars((int) asInt(0).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final String str, final int startIndex, final int length) {
        ...
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) intId().eval() > refId(java.lang.String.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("startIndex must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) arithmetic(intId(), intId(), ADD).eval() > refId(java.lang.String.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("length must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            refId(java.lang.String.class).eval().getChars((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), refId(char[].class).eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final StringBuffer str) {
        ...
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            refId(java.lang.StringBuffer.class).eval().getChars((int) asInt(0).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final StringBuffer str, final int startIndex, final int length) {
        ...
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) intId().eval() > refId(java.lang.StringBuffer.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("startIndex must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) arithmetic(intId(), intId(), ADD).eval() > refId(java.lang.StringBuffer.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("length must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            refId(java.lang.StringBuffer.class).eval().getChars((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), refId(char[].class).eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final StringBuilder str) {
        ...
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            refId(java.lang.StringBuilder.class).eval().getChars((int) asInt(0).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public StrBuilder append(final StringBuilder str, final int startIndex, final int length) {
        ...
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) intId().eval() > refId(java.lang.StringBuilder.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("startIndex must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) arithmetic(intId(), intId(), ADD).eval() > refId(java.lang.StringBuilder.class).eval().length()) {
            throw new StringIndexOutOfBoundsException("length must be valid");
        }
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int len = length();
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            refId(java.lang.StringBuilder.class).eval().getChars((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), refId(char[].class).eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    }
    ...
    public <T> StrBuilder appendAll(@SuppressWarnings("unchecked") final T... array) {
         ...
         */
        if (array != null && array.length > (int) asInt(0).eval()) {
    ...
    public StrBuilder appendFixedWidthPadLeft(final Object obj, final int width, final char padChar) {
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            ...
            final int strLen = refId(java.lang.String.class).eval().length();
            if ((boolean) relation(intId(), intId(), GE).eval()) {
                refId(java.lang.String.class).eval().getChars((int) arithmetic(intId(), intId(), SUB).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) intId().eval());
            } else {
                final int padLen = (int) arithmetic(intId(), intId(), SUB).eval();
                int _jitmagicLoopLimiter2 = 0;
                for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter2++ < 1000; i++) {
                    buffer[size + i] = (char) charId().eval();
                }
                refId(java.lang.String.class).eval().getChars((int) asInt(0).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) arithmetic(intId(), intId(), ADD).eval());
            }
            size += (int) intId().eval();
        }
        return this;
    ...
    public StrBuilder appendFixedWidthPadRight(final Object obj, final int width, final char padChar) {
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            ...
            if ((boolean) relation(intId(), intId(), GE).eval()) {
                ...
                for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter3++ < 1000; i++) {
    ...
    public StrBuilder appendPadding(final int length, final char padChar) {
        if ((boolean) relation(intId(), asInt(0), GE).eval()) {
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            int _jitmagicLoopLimiter4 = 0;
            for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter4++ < 1000; i++) {
                buffer[size++] = (char) charId().eval();
            }
        }
        return this;
    ...
    public StrBuilder appendSeparator(final String separator, final int loopIndex) {
        if (refId(java.lang.String.class).eval() != null && (boolean) relation(intId(), asInt(0), GT).eval()) {
            append(refId(java.lang.String.class).eval());
        }
        return this;
    }
    ...
    public void appendTo(final Appendable appendable) throws IOException {
        if (appendable instanceof Writer) {
            cast(Writer.class, refId(java.lang.Appendable.class)).eval().write(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
        } else if (appendable instanceof StringBuilder) {
            cast(StringBuilder.class, refId(java.lang.Appendable.class)).eval().append(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
        } else if (appendable instanceof StringBuffer) {
            cast(StringBuffer.class, refId(java.lang.Appendable.class)).eval().append(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
        } else if (appendable instanceof CharBuffer) {
            cast(CharBuffer.class, refId(java.lang.Appendable.class)).eval().put(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
        } else {
    ...
    public StrBuilder appendWithSeparators(final Object[] array, final String separator) {
        if (refId(java.lang.Object[].class).eval() != null && array.length > (int) asInt(0).eval()) {
            final String sep = Objects.toString(refId(java.lang.String.class).eval(), StringUtils.EMPTY);
            append(refArrAccessExp(java.lang.Object.class, java.lang.Object[].class, refId(java.lang.Object[].class), asInt(0)).eval());
            int _jitmagicLoopLimiter6 = 0;
            for (int i = (int) asInt(1).eval(); (int) intId().eval() < array.length && _jitmagicLoopLimiter6++ < 1000; i++) {
                append(refId(java.lang.String.class).eval());
    ...
    public char charAt(final int index) {
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) intId().eval() >= length()) {
    ...
    public boolean contains(final char ch) {
        ...
        for (int i = (int) asInt(0).eval(); (int) intId().eval() < this.size && _jitmagicLoopLimiter7++ < 1000; i++) {
            if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), EQ).eval()) {
    ...
    public boolean contains(final String str) {
        return indexOf(refId(java.lang.String.class).eval(), (int) asInt(0).eval()) >= (int) asInt(0).eval();
    }
    ...
    public boolean contains(final StrMatcher matcher) {
        return indexOf(refId(org.apache.commons.text.StrMatcher.class).eval(), (int) asInt(0).eval()) >= (int) asInt(0).eval();
    }
    ...
    public StrBuilder delete(final int startIndex, int endIndex) {
        ...
        final int len = (int) arithmetic(intId(), intId(), SUB).eval();
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
    ...
    public StrBuilder deleteAll(final char ch) {
        ...
        for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter8++ < 1000; i++) {
            if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), EQ).eval()) {
                final int start = (int) intId().eval();
                int _jitmagicLoopLimiter9 = 0;
                while (++i < (int) intId().eval() && _jitmagicLoopLimiter9++ < 1000) {
                    if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), NE).eval()) {
                        break;
                    }
                }
                final int len = (int) arithmetic(intId(), intId(), SUB).eval();
    ...
    public StrBuilder deleteAll(final String str) {
        final int len = refId(java.lang.String.class).eval() == null ? (int) asInt(0).eval() : refId(java.lang.String.class).eval().length();
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            int index = indexOf(refId(java.lang.String.class).eval(), (int) asInt(0).eval());
            int _jitmagicLoopLimiter10 = 0;
            while ((boolean) relation(intId(), asInt(0), GE).eval() && _jitmagicLoopLimiter10++ < 1000) {
                deleteImpl((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), (int) intId().eval());
    ...
    public StrBuilder deleteAll(final StrMatcher matcher) {
        return replace(refId(org.apache.commons.text.StrMatcher.class).eval(), null, (int) asInt(0).eval(), (int) intId().eval(), (int) asInt(-1).eval());
    }
    ...
    public StrBuilder deleteCharAt(final int index) {
        if ((boolean) logic(relation(intId(), asInt(0), LT), relation(intId(), intId(), GE), OR).eval()) {
            throw new StringIndexOutOfBoundsException((int) intId().eval());
        }
        deleteImpl((int) intId().eval(), (int) arithmetic(intId(), asInt(1), ADD).eval(), (int) asInt(1).eval());
        return this;
    }
    ...
    public StrBuilder deleteFirst(final char ch) {
        ...
        for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter11++ < 1000; i++) {
            if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), EQ).eval()) {
                deleteImpl((int) intId().eval(), (int) arithmetic(intId(), asInt(1), ADD).eval(), (int) asInt(1).eval());
                break;
            }
    ...
    public StrBuilder deleteFirst(final String str) {
        final int len = refId(java.lang.String.class).eval() == null ? (int) asInt(0).eval() : refId(java.lang.String.class).eval().length();
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int index = indexOf(refId(java.lang.String.class).eval(), (int) asInt(0).eval());
            if ((boolean) relation(intId(), asInt(0), GE).eval()) {
                deleteImpl((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), (int) intId().eval());
            }
        }
    ...
    private void deleteImpl(final int startIndex, final int endIndex, final int len) {
        System.arraycopy(refId(char[].class).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) intId().eval(), (int) arithmetic(intId(), intId(), SUB).eval());
        size -= (int) intId().eval();
    }
    ...
    public boolean endsWith(final String str) {
        ...
        if ((boolean) relation(intId(), asInt(0), EQ).eval()) {
            return (boolean) asBool(true).eval();
        }
        if ((boolean) relation(intId(), intId(), GT).eval()) {
            return (boolean) asBool(false).eval();
        }
        int pos = (int) arithmetic(intId(), intId(), SUB).eval();
        int _jitmagicLoopLimiter12 = 0;
        for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter12++ < 1000; i++, pos++) {
    ...
    public StrBuilder ensureCapacity(final int capacity) {
        if ((int) intId().eval() > buffer.length) {
            ...
            buffer = new char[(int) arithmetic(intId(), asInt(2), MUL).eval()];
            System.arraycopy(refId(char[].class).eval(), (int) asInt(0).eval(), refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
        }
        return this;
    }
    ...
    public boolean equals(final StrBuilder other) {
        ...
        for (int i = (int) arithmetic(intId(), asInt(1), SUB).eval(); (boolean) relation(intId(), asInt(0), GE).eval() && _jitmagicLoopLimiter13++ < 1000; i--) {
            if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), NE).eval()) {
                return (boolean) asBool(false).eval();
            }
        }
        return (boolean) asBool(true).eval();
    ...
    public boolean equalsIgnoreCase(final StrBuilder other) {
        ...
        for (int i = (int) arithmetic(intId(), asInt(1), SUB).eval(); (boolean) relation(intId(), asInt(0), GE).eval() && _jitmagicLoopLimiter14++ < 1000; i--) {
            ...
            if ((boolean) relation(cast(Integer.class, charId()), cast(Integer.class, charId()), NE).eval() && Character.toUpperCase((char) charId().eval()) != Character.toUpperCase((char) charId().eval())) {
                return (boolean) asBool(false).eval();
            }
        }
        return (boolean) asBool(true).eval();
    ...
    public void getChars(final int startIndex, final int endIndex, final char[] destination, final int destinationIndex) {
        if ((boolean) relation(intId(), asInt(0), LT).eval()) {
            throw new StringIndexOutOfBoundsException((int) intId().eval());
        }
        if ((boolean) relation(intId(), asInt(0), LT).eval() || (int) intId().eval() > length()) {
            throw new StringIndexOutOfBoundsException((int) intId().eval());
    ...
    public int hashCode() {
        ...
        int hash = (int) asInt(0).eval();
        int _jitmagicLoopLimiter15 = 0;
        for (int i = (int) arithmetic(intId(), asInt(1), SUB).eval(); (boolean) relation(intId(), asInt(0), GE).eval() && _jitmagicLoopLimiter15++ < 1000; i--) {
            hash = (int) arithmetic(arithmetic(asInt(31), intId(), MUL), cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), ADD).eval();
        }
    ...
    public int indexOf(final char ch) {
        return indexOf((char) charId().eval(), (int) asInt(0).eval());
    }
    ...
    public int indexOf(final char ch, int startIndex) {
        startIndex = Math.max((int) intId().eval(), (int) asInt(0).eval());
        if ((boolean) relation(intId(), intId(), GE).eval()) {
            return (int) asInt(-1).eval();
        }
        final char[] thisBuf = refId(char[].class).eval();
        int _jitmagicLoopLimiter16 = 0;
        for (int i = (int) intId().eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter16++ < 1000; i++) {
            if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), EQ).eval()) {
                return (int) intId().eval();
            }
        }
    ...
    public int indexOf(final String str) {
        return indexOf(refId(java.lang.String.class).eval(), (int) asInt(0).eval());
    }
    ...
    public int indexOf(final String str, int startIndex) {
        startIndex = Math.max((int) intId().eval(), (int) asInt(0).eval());
        if (refId(java.lang.String.class).eval() == null || (boolean) relation(intId(), intId(), GE).eval()) {
            return (int) asInt(-1).eval();
        }
        final int strLen = refId(java.lang.String.class).eval().length();
        if ((boolean) relation(intId(), asInt(1), EQ).eval()) {
            return indexOf(refId(java.lang.String.class).eval().charAt((int) asInt(0).eval()), (int) intId().eval());
        }
        if ((boolean) relation(intId(), asInt(0), EQ).eval()) {
            return (int) intId().eval();
        }
        ...
        final char[] thisBuf = refId(char[].class).eval();
        final int len = (int) arithmetic(arithmetic(intId(), intId(), SUB), asInt(1), ADD).eval();
    ...
    public int indexOf(final StrMatcher matcher) {
        return indexOf(refId(org.apache.commons.text.StrMatcher.class).eval(), (int) asInt(0).eval());
    }
    ...
    public int indexOf(final StrMatcher matcher, int startIndex) {
        startIndex = Math.max((int) intId().eval(), (int) asInt(0).eval());
        if (refId(org.apache.commons.text.StrMatcher.class).eval() == null || (boolean) relation(intId(), intId(), GE).eval()) {
            return (int) asInt(-1).eval();
        }
        final int len = (int) intId().eval();
        final char[] buf = refId(char[].class).eval();
        int _jitmagicLoopLimiter19 = 0;
        for (int i = (int) intId().eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter19++ < 1000; i++) {
            if (refId(org.apache.commons.text.StrMatcher.class).eval().isMatch(refId(char[].class).eval(), (int) intId().eval(), (int) intId().eval(), (int) intId().eval()) > (int) asInt(0).eval()) {
                return (int) intId().eval();
            }
        }
        return (int) asInt(-1).eval();
    ...
    public StrBuilder insert(int index, final boolean value) {
        ...
        if ((boolean) boolId().eval()) {
            ensureCapacity((int) arithmetic(intId(), asInt(4), ADD).eval());
            System.arraycopy(refId(char[].class).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) arithmetic(intId(), asInt(4), ADD).eval(), (int) arithmetic(intId(), intId(), SUB).eval());
            buffer[index++] = (char) asChar('t').eval();
            buffer[index++] = (char) asChar('r').eval();
            buffer[index++] = (char) asChar('u').eval();
            buffer[index] = (char) asChar('e').eval();
            size += (int) asInt(4).eval();
        } else {
            ensureCapacity((int) arithmetic(intId(), asInt(5), ADD).eval());
            System.arraycopy(refId(char[].class).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) arithmetic(intId(), asInt(5), ADD).eval(), (int) arithmetic(intId(), intId(), SUB).eval());
            buffer[index++] = (char) asChar('f').eval();
            buffer[index++] = (char) asChar('a').eval();
            buffer[index++] = (char) asChar('l').eval();
            buffer[index++] = (char) asChar('s').eval();
            buffer[index] = (char) asChar('e').eval();
            size += (int) asInt(5).eval();
        }
        return this;
    }
    ...
    public StrBuilder insert(final int index, final char value) {
        validateIndex((int) intId().eval());
        ensureCapacity((int) arithmetic(intId(), asInt(1), ADD).eval());
        System.arraycopy(refId(char[].class).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) arithmetic(intId(), asInt(1), ADD).eval(), (int) arithmetic(intId(), intId(), SUB).eval());
    ...
    public StrBuilder insert(final int index, final char[] chars) {
        ...
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            ensureCapacity((int) arithmetic(intId(), intId(), ADD).eval());
            System.arraycopy(refId(char[].class).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) arithmetic(intId(), intId(), ADD).eval(), (int) arithmetic(intId(), intId(), SUB).eval());
            System.arraycopy(refId(char[].class).eval(), (int) asInt(0).eval(), refId(char[].class).eval(), (int) intId().eval(), (int) intId().eval());
            size += (int) intId().eval();
        }
        return this;
    ...
    public StrBuilder insert(final int index, String str) {
        ...
        if (refId(java.lang.String.class).eval() != null) {
            final int strLen = refId(java.lang.String.class).eval().length();
            if ((boolean) relation(intId(), asInt(0), GT).eval()) {
                final int newSize = (int) arithmetic(intId(), intId(), ADD).eval();
    ...
    public boolean isEmpty() {
        return (boolean) relation(intId(), asInt(0), EQ).eval();
    }
    ...
    public boolean isNotEmpty() {
        return (boolean) relation(intId(), asInt(0), GT).eval();
    }
    ...
    public int lastIndexOf(final char ch) {
        return lastIndexOf((char) charId().eval(), (int) arithmetic(intId(), asInt(1), SUB).eval());
    }
    ...
    public int lastIndexOf(final char ch, int startIndex) {
        startIndex = (boolean) relation(intId(), intId(), GE).eval() ? (int) arithmetic(intId(), asInt(1), SUB).eval() : (int) intId().eval();
        if ((boolean) relation(intId(), asInt(0), LT).eval()) {
            return (int) asInt(-1).eval();
        }
        int _jitmagicLoopLimiter20 = 0;
        for (int i = (int) intId().eval(); (boolean) relation(intId(), asInt(0), GE).eval() && _jitmagicLoopLimiter20++ < 1000; i--) {
            if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), EQ).eval()) {
                return (int) intId().eval();
            }
        }
    ...
    public int lastIndexOf(final String str) {
        return lastIndexOf(refId(java.lang.String.class).eval(), (int) arithmetic(intId(), asInt(1), SUB).eval());
    }
    ...
    public int lastIndexOf(final String str, int startIndex) {
        startIndex = (boolean) relation(intId(), intId(), GE).eval() ? (int) arithmetic(intId(), asInt(1), SUB).eval() : (int) intId().eval();
        if (refId(java.lang.String.class).eval() == null || (boolean) relation(intId(), asInt(0), LT).eval()) {
            return (int) asInt(-1).eval();
        }
        final int strLen = refId(java.lang.String.class).eval().length();
        if ((boolean) logic(relation(intId(), asInt(0), GT), relation(intId(), intId(), LE), AND).eval()) {
            if ((boolean) relation(intId(), asInt(1), EQ).eval()) {
                return lastIndexOf(refId(java.lang.String.class).eval().charAt((int) asInt(0).eval()), (int) intId().eval());
            }
        ...
        } else if ((boolean) relation(intId(), asInt(0), EQ).eval()) {
            return (int) intId().eval();
        }
        return (int) asInt(-1).eval();
    }
    ...
    public int lastIndexOf(final StrMatcher matcher, int startIndex) {
        startIndex = (boolean) relation(intId(), intId(), GE).eval() ? (int) arithmetic(intId(), asInt(1), SUB).eval() : (int) intId().eval();
        if (refId(org.apache.commons.text.StrMatcher.class).eval() == null || (boolean) relation(intId(), asInt(0), LT).eval()) {
            return (int) asInt(-1).eval();
        }
        final char[] buf = refId(char[].class).eval();
        final int endIndex = (int) arithmetic(intId(), asInt(1), ADD).eval();
        int _jitmagicLoopLimiter23 = 0;
        for (int i = (int) intId().eval(); (boolean) relation(intId(), asInt(0), GE).eval() && _jitmagicLoopLimiter23++ < 1000; i--) {
            if (refId(org.apache.commons.text.StrMatcher.class).eval().isMatch(refId(char[].class).eval(), (int) intId().eval(), (int) asInt(0).eval(), (int) intId().eval()) > (int) asInt(0).eval()) {
                return (int) intId().eval();
            }
        }
        return (int) asInt(-1).eval();
    ...
    public String leftString(final int length) {
        ...
        if ((boolean) relation(intId(), intId(), GE).eval()) {
            return new String(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
        }
        return new String(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
    }
    ...
    public String midString(int index, final int length) {
        if ((boolean) relation(intId(), asInt(0), LT).eval()) {
            index = (int) asInt(0).eval();
        }
        if ((boolean) logic(relation(intId(), asInt(0), LE), relation(intId(), intId(), GE), OR).eval()) {
            return StringUtils.EMPTY;
        }
        if ((boolean) relation(intId(), arithmetic(intId(), intId(), ADD), LE).eval()) {
            return new String(refId(char[].class).eval(), (int) intId().eval(), (int) arithmetic(intId(), intId(), SUB).eval());
        }
    ...
    public int readFrom(final Readable readable) throws IOException {
        ...
        if (readable instanceof Reader) {
            ...
            while ((read = refId(java.io.Reader.class).eval().read(refId(char[].class).eval(), (int) intId().eval(), buffer.length - (int) intId().eval())) != (int) asInt(-1).eval() && _jitmagicLoopLimiter24++ < 1000) {
                size += (int) intId().eval();
                ensureCapacity((int) arithmetic(intId(), asInt(1), ADD).eval());
            }
            ...
            while ((boolean) asBool(true).eval() && _jitmagicLoopLimiter25++ < 1000) {
                ensureCapacity((int) arithmetic(intId(), asInt(1), ADD).eval());
        ...
        return (int) arithmetic(intId(), intId(), SUB).eval();
    }
    ...
    public StrBuilder replace(final int startIndex, int endIndex, final String replaceStr) {
        endIndex = validateRange((int) intId().eval(), (int) intId().eval());
        final int insertLen = refId(java.lang.String.class).eval() == null ? (int) asInt(0).eval() : refId(java.lang.String.class).eval().length();
        replaceImpl((int) intId().eval(), (int) intId().eval(), (int) arithmetic(intId(), intId(), SUB).eval(), refId(java.lang.String.class).eval(), (int) intId().eval());
        return this;
    }
    ...
    public StrBuilder replaceAll(final char search, final char replace) {
        if ((boolean) relation(cast(Integer.class, charId()), cast(Integer.class, charId()), NE).eval()) {
            int _jitmagicLoopLimiter26 = 0;
            for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter26++ < 1000; i++) {
                if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), EQ).eval()) {
    ...
    public StrBuilder replaceAll(final String searchStr, final String replaceStr) {
        final int searchLen = refId(java.lang.String.class).eval() == null ? (int) asInt(0).eval() : refId(java.lang.String.class).eval().length();
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            final int replaceLen = refId(java.lang.String.class).eval() == null ? (int) asInt(0).eval() : refId(java.lang.String.class).eval().length();
            int index = indexOf(refId(java.lang.String.class).eval(), (int) asInt(0).eval());
            int _jitmagicLoopLimiter27 = 0;
            while ((boolean) relation(intId(), asInt(0), GE).eval() && _jitmagicLoopLimiter27++ < 1000) {
                replaceImpl((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), (int) intId().eval(), refId(java.lang.String.class).eval(), (int) intId().eval());
                index = indexOf(refId(java.lang.String.class).eval(), (int) arithmetic(intId(), intId(), ADD).eval());
            }
        }
        return this;
    }
    ...
    public StrBuilder replaceAll(final StrMatcher matcher, final String replaceStr) {
        return replace(refId(org.apache.commons.text.StrMatcher.class).eval(), refId(java.lang.String.class).eval(), (int) asInt(0).eval(), (int) intId().eval(), (int) asInt(-1).eval());
    }
    ...
    public StrBuilder replaceFirst(final char search, final char replace) {
        if ((boolean) relation(cast(Integer.class, charId()), cast(Integer.class, charId()), NE).eval()) {
            ...
            for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter28++ < 1000; i++) {
                if ((boolean) relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, charId()), EQ).eval()) {
                    buffer[i] = (char) charId().eval();
                    break;
                }
    ...
    private void replaceImpl(final int startIndex, final int endIndex, final int removeLen, final String insertStr, final int insertLen) {
        final int newSize = (int) arithmetic(arithmetic(intId(), intId(), SUB), intId(), ADD).eval();
        if ((boolean) relation(intId(), intId(), NE).eval()) {
            ensureCapacity((int) intId().eval());
            System.arraycopy(refId(char[].class).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) arithmetic(intId(), intId(), ADD).eval(), (int) arithmetic(intId(), intId(), SUB).eval());
            size = (int) intId().eval();
        }
    ...
    private StrBuilder replaceImpl(final StrMatcher matcher, final String replaceStr, final int from, int to, int replaceCount) {
        if (refId(org.apache.commons.text.StrMatcher.class).eval() == null || (boolean) relation(intId(), asInt(0), EQ).eval()) {
            return this;
        }
        final int replaceLen = refId(java.lang.String.class).eval() == null ? (int) asInt(0).eval() : refId(java.lang.String.class).eval().length();
        int _jitmagicLoopLimiter29 = 0;
        for (int i = (int) intId().eval(); (boolean) logic(relation(intId(), intId(), LT), relation(intId(), asInt(0), NE), AND).eval() && _jitmagicLoopLimiter29++ < 1000; i++) {
            final char[] buf = refId(char[].class).eval();
            ...
            if ((boolean) relation(intId(), asInt(0), GT).eval()) {
                replaceImpl((int) intId().eval(), (int) arithmetic(intId(), intId(), ADD).eval(), (int) intId().eval(), refId(java.lang.String.class).eval(), (int) intId().eval());
                to = (int) arithmetic(arithmetic(intId(), intId(), SUB), intId(), ADD).eval();
                i = (int) arithmetic(arithmetic(intId(), intId(), ADD), asInt(1), SUB).eval();
                if ((boolean) relation(intId(), asInt(0), GT).eval()) {
                    replaceCount--;
                }
            }
    ...
    public StrBuilder reverse() {
        ...
        final int half = (int) arithmetic(intId(), asInt(2), DIV).eval();
        final char[] buf = refId(char[].class).eval();
        int _jitmagicLoopLimiter30 = 0;
        for (int leftIdx = (int) asInt(0).eval(), rightIdx = (int) arithmetic(intId(), asInt(1), SUB).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter30++ < 1000; leftIdx++, rightIdx--) {
    ...
    public String rightString(final int length) {
        ...
        return new String(refId(char[].class).eval(), (int) arithmetic(intId(), intId(), SUB).eval(), (int) intId().eval());
    }
    ...
    public StrBuilder setLength(final int length) {
        ...
        if ((boolean) relation(intId(), intId(), LT).eval()) {
            size = (int) intId().eval();
        } else if ((boolean) relation(intId(), intId(), GT).eval()) {
            ensureCapacity((int) intId().eval());
            final int oldEnd = (int) intId().eval();
            size = (int) intId().eval();
            int _jitmagicLoopLimiter31 = 0;
            for (int i = (int) intId().eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter31++ < 1000; i++) {
                buffer[i] = (char) asChar('\0').eval();
            }
        }
        return this;
    }
    ...
    public boolean startsWith(final String str) {
        ...
        for (int i = (int) asInt(0).eval(); (boolean) relation(intId(), intId(), LT).eval() && _jitmagicLoopLimiter32++ < 1000; i++) {
            if ((char) charArrAccessExp(refId(char[].class), intId()).eval() != refId(java.lang.String.class).eval().charAt((int) intId().eval())) {
                return (boolean) asBool(false).eval();
            }
        }
    ...
    public CharSequence subSequence(final int startIndex, final int endIndex) {
        ...
        if ((boolean) relation(intId(), intId(), GT).eval()) {
            throw new StringIndexOutOfBoundsException((int) arithmetic(intId(), intId(), SUB).eval());
        }
    ...
    public char[] toCharArray() {
        return (boolean) relation(intId(), asInt(0), EQ).eval() ? ArrayUtils.EMPTY_CHAR_ARRAY : Arrays.copyOf(refId(char[].class).eval(), (int) intId().eval());
    }
    ...
    public char[] toCharArray(final int startIndex, int endIndex) {
        ...
        System.arraycopy(refId(char[].class).eval(), (int) intId().eval(), refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
        return refId(char[].class).eval();
    }
    ...
    public StringBuffer toStringBuffer() {
        return new StringBuffer((int) intId().eval()).append(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
    }
    ...
    public StringBuilder toStringBuilder() {
        return new StringBuilder((int) intId().eval()).append(refId(char[].class).eval(), (int) asInt(0).eval(), (int) intId().eval());
    }
    ...
    public StrBuilder trim() {
        ...
        final char[] buf = refId(char[].class).eval();
        int pos = (int) asInt(0).eval();
        int _jitmagicLoopLimiter33 = 0;
        while ((boolean) logic(relation(intId(), intId(), LT), relation(cast(Integer.class, charArrAccessExp(refId(char[].class), intId())), cast(Integer.class, asChar(' ')), LE), AND).eval() && _jitmagicLoopLimiter33++ < 1000) {
            pos++;
        }
        int _jitmagicLoopLimiter34 = 0;
        while ((boolean) logic(relation(intId(), intId(), LT), relation(cast(Integer.class, charArrAccessExp(refId(char[].class), arithmetic(intId(), asInt(1), SUB))), cast(Integer.class, asChar(' ')), LE), AND).eval() && _jitmagicLoopLimiter34++ < 1000) {
            len--;
        }
        if ((boolean) relation(intId(), intId(), LT).eval()) {
        ...
        if ((boolean) relation(intId(), asInt(0), GT).eval()) {
            delete((int) asInt(0).eval(), (int) intId().eval());
        }
        return this;
    }
