...
public class PhoneticEnginem210TemplateGen1 {
    ...
    static final class PhonemeBuilder {
            ...
            EXPR: for (final Rule.Phoneme left : this.phonemes) {
                for (final Rule.Phoneme right : phonemeExpr.getPhonemes()) {
                    ...
                    if (!languages.isEmpty()) {
                        ...
                        if (newPhonemes.size() < (int) intId().eval(1)) {
                            newPhonemes.add(join);
                            if (newPhonemes.size() >= (int) intId().eval(2)) {
                                break EXPR;
                            }
                        }
                    }
        ...
        public String makeString() {
            ...
            for (final Rule.Phoneme ph : this.phonemes) {
                if (sb.length() > (int) intVal().eval(3)) {
                    sb.append("|");
                }
    ...
    private static final class RulesApplication {
        ...
        public RulesApplication invoke() {
            this.found = false;
            int patternLength = (int) intVal().eval(4);
            ...
            if (!this.found) {
                patternLength = (int) intVal().eval(5);
            }
    ...
    public PhoneticEnginem210TemplateGen1(final NameType nameType, final RuleType ruleType, final boolean concat) {
        this(nameType, ruleType, concat, DEFAULT_MAX_PHONEMES);
    }

    public PhoneticEnginem210TemplateGen1(final NameType nameType, final RuleType ruleType, final boolean concat, final int maxPhonemes) {
    ...
    private PhonemeBuilder applyFinalRules(final PhonemeBuilder phonemeBuilder, final Map<String, List<Rule>> finalRules) {
        ...
        for (final Rule.Phoneme phoneme : phonemeBuilder.getPhonemes()) {
            ...
            for (int i = (int) intVal().eval(8); (int) intId().eval(7) < phonemeText.length() && _jitmagicLoopLimiter2++ < 1000; ) {
                ...
                if (!found) {
                    subBuilder.append(phonemeText.subSequence(i, arithmetic(intId(), intVal()).eval(6)));
                }
    ...
    public String encode(String input, final Languages.LanguageSet languageSet) {
        ...
        if (this.nameType == NameType.GENERIC) {
            if (input.length() >= (int) intVal().eval(9) && input.substring(0, 2).equals("d'")) {
                final String remainder = input.substring((int) intVal().eval(10));
                final String combined = "d" + remainder;
                return "(" + encode(remainder) + ")-(" + encode(combined) + ")";
            }
            for (final String l : NAME_PREFIXES.get(this.nameType)) {
                if (input.startsWith(l + " ")) {
                    final String remainder = input.substring(l.length() + (int) intVal().eval(11));
        ...
        if (this.concat) {
            input = join(words2, " ");
        } else if (words2.size() == (int) -66284074) {
        ...
        for (int i = (int) intVal().eval(14); (int) intId().eval(13) < input.length() && _jitmagicLoopLimiter3++ < 1000; ) {
    ...
    public static Object[] args() {
        ...
        org.apache.commons.codec.language.bm.PhoneticEnginem210TemplateGen1 phoneticEngine5 = new org.apache.commons.codec.language.bm.PhoneticEnginem210TemplateGen1(nameType0, ruleType1, true, (int) (byte) -1);
        ...
        org.apache.commons.codec.language.bm.PhoneticEnginem210TemplateGen1 phoneticEngine11 = new org.apache.commons.codec.language.bm.PhoneticEnginem210TemplateGen1(nameType6, ruleType7, true, (int) (byte) -1);
        org.apache.commons.codec.language.bm.PhoneticEnginem210TemplateGen1 phoneticEngine14 = new org.apache.commons.codec.language.bm.PhoneticEnginem210TemplateGen1(nameType0, ruleType7, false, (int) (byte) 0);
    ...
    public static long main0(String[] args) {
        ...
        try {
            Object[] eArgs = args();
            cs.update(eArgs);
            PhoneticEnginem210TemplateGen1 rcvr = (PhoneticEnginem210TemplateGen1) eArgs[0];
            for (int i = 0; i < N; ++i) {
                try {
                    cs.update(rcvr.getRuleType());
                } catch (Throwable e) {
        ...
        cs.updateStaticFieldsOfClass(PhoneticEnginem210TemplateGen1.class);
        return cs.getValue();
    }
