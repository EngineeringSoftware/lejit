...
public class ComplexUtilsm182Template {

    private ComplexUtilsm182Template() {
    }
    ...
    public static Complex[] real2Complex(double[] real, int start, int end) {
        final Range range = IntegerSequence.range(intId().eval(), intId().eval());
    ...
    public static Complex[] real2Complex(double[] real, int start, int end, int increment) {
        final Range range = IntegerSequence.range(intId().eval(), intId().eval(), intId().eval());
        int index = intVal().eval();
        final Complex[] c = new Complex[range.size()];
        for (Integer i : range) {
            c[intVal(0, c.length).eval()] = extractComplexFromRealArray(real, i);
    ...
    public static Complex[][] real2Complex(double[][] d) {
        ...
        for (int n = 0; n < intId().eval(); n++) {
            c[intVal(0, c.length).eval()] = ComplexUtilsm182Template.real2Complex(d[n]);
        }
        return c;
    }
    ...
    public static Complex[][][] real2Complex(double[][][] d) {
        ...
        final Complex[][][] c = new Complex[width][][];
        for (int x = 0; x < intId().eval(); x++) {
            c[intVal(0, c.length).eval()] = ComplexUtilsm182Template.real2Complex(d[x]);
        }
        return c;
    }
    ...
    public static Complex[][] imaginary2Complex(double[][] d) {
        ...
        for (int n = 0; n < intId().eval(); n++) {
            c[intVal(0, c.length).eval()] = ComplexUtilsm182Template.imaginary2Complex(d[n]);
        }
        return c;
    }
    ...
    public static Complex[][][] imaginary2Complex(double[][][] d) {
        ...
        for (int x = 0; x < intId().eval(); x++) {
            for (int y = 0; y < intId().eval(); y++) {
                c[x][intVal(0, c[x].length).eval()] = ComplexUtilsm182Template.imaginary2Complex(d[x][y]);
            }
        }
        return c;
    }
    ...
    public static Complex[][] split2ComplexTemplate(double[][] real, double[][] imag) {
        ...
        for (int x = 0; x < intId().eval(); x++) {
            c[intVal(0, c.length).eval()] = split2ComplexTemplate(real[x], imag[x]);
        }
        return c;
    }
    ...
    public static double[][] nonPrim1() {
        return new double[][] { { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() } };
    }

    @Argument(2)
    public static double[][] nonPrim2() {
        return new double[][] { { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() }, { intVal().eval(), intVal().eval() } };
    }
}
